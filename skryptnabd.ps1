...
Invoke-SqlQuery -query "CREATE TABLE Nagrody (id_nagr int, imie_psa varchar(20),wartosc_nagr int, rasa varchar(20),id_psa int, FOREIGN KEY (id_psa) REFERENCES Psy (id_psa));"
